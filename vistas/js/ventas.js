...
function listar()
{
  ...
  //-------------------VER DETALLE CLIENTE-VENTA-----------------------//
	 $(document).on('click', '.detalle', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$("#nit").html(data.nit);
				$("#direccionCliente").html(data.direccionCliente);
				$("#fechaVenta").html(data.fechaVenta);
    ...
    function cambiarEstado(idVentas, numero_venta, est){
	...
	bootbox.confirm("¿Estas seguro que quieres anular esta compra?", function(result){
		if(result)
		{
			...
			$.ajax({
				...
				data:{idVentas:idVentas, numero_venta:numero_venta, est:est},
				cache: false,
